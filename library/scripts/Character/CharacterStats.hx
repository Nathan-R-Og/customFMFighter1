// Character stats for CharacterTemplate
{
	...
	spriteContent: self.getResource().getContent("Machine"),
	//GENERIC STATS
	...
	doubleJumpSpeeds: [8.125],
	terminalVelocity: 9.25,
	fastFallSpeed: 23.75,
	friction: 1.57,
	walkSpeedInitial: 3.0,
	walkSpeedAcceleration: 2,
	walkSpeedCap: 5.55,
	dashSpeed: 9.5,
	runSpeedInitial: 4.75,
	runSpeedAcceleration: 2,
	runSpeedCap: 9.5,
	groundSpeedAcceleration: 5,
	groundSpeedCap: 12.5,
	aerialSpeedAcceleration: 2.45,
	aerialSpeedCap: 8.5,
	aerialFriction: 2.22,
